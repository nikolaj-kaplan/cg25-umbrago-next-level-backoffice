...
namespace CG25NextLevelBackoffice.Composers
{
    public class CG25NextLevelBackofficeApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "CG25Next Level Backoffice Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<CG25NextLevelBackofficeOperationSecurityFilter>();
            });
        }

        public class CG25NextLevelBackofficeOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("CG25NextLevelBackoffice.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
